                    ...
                    <Card className={classes.card}>
                      ...
                      <Card.Body className={classes.cardBody}>
                        ...
                        <Card.Text className={classes.cardText}>
                          {fav.body.length > 2 ? (
                            <>
                              {fav.body.slice(0, 2).map((item, index) => (
                                <span key={index}>
                                  {item}
                                  <br />
                                </span>
                              ))}
                              <span className={classes.ellipsis}>...more</span>
                            </>
                          ) : (
                        ...
                        <div className={classes.buttonContainer}>
                          <OverlayTrigger
                            ...
                            placement="top"
                            overlay={
                              <Tooltip id={`tooltip-like-${fav.recipeId}`}>
                          ...
                          >
                            <Button
                              disabled={isDisabled}
                              onClick={() =>
                                handleLikeButton(fav.recipeId, fav.isLiked)
                              }
                              className={classes.recipeButton}
                            >
                              {fav.isLiked ? <FaHeart /> : <FaRegHeart />}
                            </Button>
                          </OverlayTrigger>
                          ...
                          <OverlayTrigger
                            ...
                            placement="top"
                            overlay={
                              <Tooltip id={`tooltip-bookmark-${fav.recipeId}`}>
                                Remove
                              </Tooltip>
                            }
                          >
                            <Button
                              disabled={isDisabled}
                              onClick={() =>
                                handleRemoveFromFavoritesButton(fav.recipeId)
                              }
                              className={classes.recipeButton}
                            >
                              <FaBookmark />
                          ...
                          >
                            <Button
                              onClick={() => handleGoToRecipe(fav.recipeId)}
                              className={classes.recipeButton}
                            >
                              <FaArrowCircleRight />
                            </Button>
