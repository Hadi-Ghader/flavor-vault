...
namespace Flavor_Vault
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<ICommentRepository, CommentRepository>(provider => new CommentRepository(connectionString!));
            builder.Services.AddScoped<IRatingRepository, RatingRepository>(provider => new RatingRepository(connectionString!));
